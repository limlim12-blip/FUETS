...
const Composer = forwardRef(function Composer({ onSend, busy }, ref) {
    ...
    return (
        <div className="border-t border-zinc-200/60 p-4 sm:px-8 lg:px-12 dark:border-zinc-800">
            <div
                className={cls(
                    "mx-auto flex flex-col rounded-3xl border bg-white shadow-sm dark:bg-zinc-950 transition-all duration-200",
                    "w-full max-w-3xl border-zinc-200 dark:border-zinc-800",
                )}
            >
            ...
            <div className="mx-auto mt-2 w-full max-w-3xl px-1 text-center text-[11px] text-zinc-400 dark:text-zinc-500">
